...
const AddUserIcon: FC<AddUserProps> = ({ size, color }) => (
     <svg
          style={{
          ...
          <path d="M19 16V10" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M16 13L22 13" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
