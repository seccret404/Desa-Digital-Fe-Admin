...
const PengumumanIcon: FC<PengumumanProps> = ({ size, color }) => (
     <svg style={{
          ...
          <path d="M18.0186 2.01367C19.3978 3.05299 20.4843 4.43177 21.1724 6.01574" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M5.98197 2.01367C4.60275 3.05299 3.5162 4.43177 2.82812 6.01574" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
     </svg>

)

export default PengumumanIcon;