...
import DetailAgenda from './pages/agenda_desa/detail_laporan'
import EditLaporanAgenda from './pages/agenda_desa/editLaporan'
import EditTugasWewenang from './pages/data_desa/TugasWewenang/edit'
import EditPemerintah from './pages/data_desa/pemerintahan/edit'
    ...
    return (
      <Router>
        ...
        <Route path="/" element={isLoggedIn ? <Navigate to="/dashboard" /> : <Login setIsLoggedIn={setIsLoggedIn} />} />
          ...
          <Route path="/pemerintahan/:id" element={<PrivateRoute isLoggedIn={isLoggedIn}><EditPemerintah /></PrivateRoute>} />
          ...
          <Route path="/tugas-wewenang/:id" element={<PrivateRoute isLoggedIn={isLoggedIn}><EditTugasWewenang /></PrivateRoute>} />
          ...
          <Route path="/detail-agenda/:id" element={<PrivateRoute isLoggedIn={isLoggedIn}><DetailAgenda /></PrivateRoute>} />
          <Route path="/laporan-agenda/:id" element={<PrivateRoute isLoggedIn={isLoggedIn}><LaporanAgenda /></PrivateRoute>} />
          <Route path="/edit-laporan/:id" element={<PrivateRoute isLoggedIn={isLoggedIn}><EditLaporanAgenda /></PrivateRoute>} />
