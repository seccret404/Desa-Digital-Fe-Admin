                                        ...
                                        {[...Array(6)].map((_, index) => (
                                             <div className="bg-white p-4 rounded-[5px]">
                                                  <div key={index} className="umkm">
                                                       <div className="">
                                                            <img src='assets/umkm.jpeg' className='w-full' alt="Logo UMKM" />
                                                       </div>
                                                       <div className="text-[#0890EA] text-[16px] pt-1">
                                                            UMKM 1
                                                       </div>
                                                       <div className="">
                                                            UMKM memainkan peran penting dalam perekonomian karena mereka seringkali menjadi motor penggerak pertumbuhan ekonomi.
                                                       </div>
